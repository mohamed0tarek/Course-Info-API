...
public class CourseRetrievalService {
    ...
    public List<PluralsightCourse> getCoursesFor(String authorId) {
        List<PluralsightCourse> pluralsightCourses = new ArrayList<>();
        ...
        try {
            ...
            return switch (response.statusCode()){
                ...
                case 404 -> List.of();
                default -> throw new RuntimeException("failed to called Pluralsight API with status code " + response.statusCode());
            };
